...
"""
    ...
    script_path = DIST_DIR / "setup.iss"
    with open(script_path, "w", encoding="utf-8") as f:
        f.write(inno_setup_script)
    
    print(f"  Inno Setup 脚本已创建: {script_path}")
    print("  请使用 Inno Setup Compiler 编译此脚本以生成安装程序")
...
def main():
    print("="*60)
    print("    Security Toolkit 打包脚本")
    print("="*60)
    
    print("\n选择操作:")
    print("  1. 完整构建 (清理 + 构建 + 便携版 + 安装脚本)")
    print("  2. 仅构建")
    print("  3. 仅创建便携版")
    print("  4. 仅创建安装脚本")
    print("  5. 清理构建文件")
